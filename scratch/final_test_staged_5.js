    ...
    function getPDFSettings(year) {
        const defaults = { orgName: 'αñ╢αñ┐αñ╡αñ╕αÑâαñ╖αÑìαñƒαÑÇ αñ╕αñ╛αñ░αÑìαñ╡αñ£αñ¿αñ┐αñò αñëαññαÑìαñ╕αñ╡ αñ«αñéαñíαñ│ αñ╕αñéαñùαñ«αñ¿αÑçαñ░ ≡ƒÜ⌐', subtitle: 'αñùαñúαÑçαñ╢ αñëαññαÑìαñ╕αñ╡ αñòαÑàαñ╢αñ¼αÑüαñò', tagline: 'Ganpati Festival Cashbook', headerOrgName: '', headerSubtitle: '' };
        try {
        ...
        try {
            ...
            if (response.ok) {
                ...
                if (niyojans.length === 0) {
                    grid.innerHTML = '<p style="text-align: center; color: white;">αñòαÑïαñúαññαÑçαñ╣αÑÇ αñ¿αñ┐αñ»αÑïαñ£αñ¿ αñëαñ¬αñ▓αñ¼αÑìαñº αñ¿αñ╛αñ╣αÑÇ.</p>';
                    return;
                }
                        ...
                        <div class="niyojan-item animate-fade-up" style="animation-delay: ${index * 0.1}s; display: flex; gap: 20px; margin-bottom: 25px;">
                            ...
                            <div class="glass-panel" style="flex: 1; padding: 15px 20px; border-left: 3px solid #d4af37; background: rgba(255,255,255,0.05);">
                                <div style="display: flex; justify-content: space-between; flex-wrap: wrap; gap: 10px; margin-bottom: 8px;">
                                    ...
                                    <span style="background: rgba(212,175,55,0.2); color: #ffeb3b; padding: 2px 10px; border-radius: 20px; font-size: 0.9rem;"><i class="far fa-clock"></i> ${item.time}</span>
                                </div>
                                <h3 style="color: #fff; font-family: 'Khand', sans-serif; font-size: 1.6rem; margin: 0 0 5px 0;">${item.title}</h3>
                                ${item.description ? `<p style="color: #ccc; font-size: 0.95rem; margin: 0; line-height: 1.4;">${item.description}</p>` : ''}
                            </div>
                        </div>
                    `;
                });
    ...
    async function loadAartiDataHome() {
        try {
            ...
            if (response.ok) {
                ...
                if (aartis.length === 0) {
                    grid.innerHTML = '<p style="text-align: center; color: white; width: 100%;">αñòαÑïαñúαññαÑÇαñ╣αÑÇ αñ«αñ╣αñ╛αñåαñ░αññαÑÇ αñ¿αÑïαñéαñªαñ╡αñ▓αÑÇ αñ¿αñ╛αñ╣αÑÇ.</p>';
                    return;
                }
                    ...
                    html += `
                        <div class="aarti-item glass-panel" style="padding: 15px; margin-bottom: 15px; border-left: 4px solid #ffcc00; background: rgba(255,255,255,0.1);">
                            ...
                            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px; color: #fff; font-size: 0.95rem;">
                                <div><strong style="color: #ffcc00;">αññαñ╛αñ░αÑÇαñû:</strong> ${formattedDate}</div>
                                <div><strong style="color: #ffcc00;">αñ╡αÑçαñ│:</strong> ${aarti.timeOfDay}</div>
                            </div>
                            ${aarti.pujaDetails ? `<div style="margin-top: 10px; color: #eee; font-size: 0.9rem;"><strong style="color: #ffcc00;">αñ¬αÑéαñ£αñ╛ αñ«αñ╛αñ╣αñ┐αññαÑÇ:</strong> ${aarti.pujaDetails}</div>` : ''}
                        </div>
                    `;
                });
                grid.innerHTML = html;
        ...
        try {
            ...
            if (result.success && result.data.length > 0) {
                ...
                const generateMemberHTML = (member) => {
                    let roleName = 'αñ╕αñªαñ╕αÑìαñ»';
                    if (member.role === 'president') roleName = 'αñàαñºαÑìαñ»αñòαÑìαñ╖';
                    else if (member.role === 'treasurer') roleName = 'αñûαñ£αñ┐αñ¿αñªαñ╛αñ░';
                    ...
                    const mobileHtml = member.mobile ? `<p class="member-phone">αñ«αÑï.αñ¿αñé ${member.mobile}</p>` : '<p class="member-phone" style="display:none;"></p>';
                    const memberName = member.name || 'αñ¿αñ╛αñ╡ αñƒαñ╛αñòαñ╛';
                ...
                topMembers.forEach(member => {
                    if (member.role === 'president') {
                        ...
                        document.getElementById('contact-president-name').textContent = member.name || 'αñ¿αñ╛αñ╡ αñƒαñ╛αñòαñ╛';
                        document.getElementById('contact-president-mobile').textContent = member.mobile ? `αñ«αÑï.αñ¿αñé ${member.mobile}` : '';
                        ...
                        if (member.mobile) {
                            ...
                            waLink.href = `https://wa.me/91${member.mobile}?text=αñ¿αñ«αñ╕αÑìαñòαñ╛αñ░%20${member.name},%20αñ╢αñ┐αñ╡αñ╕αÑâαñ╖αÑìαñƒαÑÇ%20αñ«αñéαñíαñ│αñ╛αñ¼αñ╛αñ¼αññ%20αñ╕αñéαñ¬αñ░αÑìαñò%20αñ╕αñ╛αñºαññ%20αñåαñ╣αÑç.`;
                        } else {
                            waLink.style.display = 'none';
                        }
                    } else if (member.role === 'treasurer') {
                        document.getElementById('contact-card-treasurer').style.display = 'flex';
                        document.getElementById('contact-treasurer-name').textContent = member.name || 'αñ¿αñ╛αñ╡ αñƒαñ╛αñòαñ╛';
                        document.getElementById('contact-treasurer-mobile').textContent = member.mobile ? `αñ«αÑï.αñ¿αñé ${member.mobile}` : '';
...
<div class="cover-page">
  ...
  <div class="cover-content">
    ...
    <div class="cover-mandal-name">${s.orgName === 'αñ╢αñ┐αñ╡αñ╕αÑâαñ╖αÑìαñƒαÑÇ αñ╕αñ╛αñ░αÑìαñ╡αñ£αñ¿αñ┐αñò αñëαññαÑìαñ╕αñ╡ αñ«αñéαñíαñ│ αñ╕αñéαñùαñ«αñ¿αÑçαñ░ ≡ƒÜ⌐' ? '<div style="font-size:1.4em; color:#ffd700; text-shadow:0 0 25px rgba(255,140,0,1); line-height:1.2; margin-bottom:12px;">αñ╢αñ┐αñ╡αñ╕αÑâαñ╖αÑìαñƒαÑÇ</div><div style="font-size:0.9em; color:#ffcc00; margin-bottom:5px;">αñ╕αñ╛αñ░αÑìαñ╡αñ£αñ¿αñ┐αñò αñëαññαÑìαñ╕αñ╡ αñ«αñéαñíαñ│</div><div style="font-size:0.9em; color:#ffcc00;"><span style="color:transparent;user-select:none;">≡ƒÜ⌐ </span>αñ╕αñéαñùαñ«αñ¿αÑçαñ░ ≡ƒÜ⌐</div>' : s.orgName}</div>
